...
export function getSdk(
  ...
  return {
    RepoBasicInfoWithTag(
      variables: RepoBasicInfoWithTagQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RepoBasicInfoWithTagQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RepoBasicInfoWithTagQuery>(
            RepoBasicInfoWithTagDocument,
            variables,
