...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    RepoBasicInfoWithTag(variables: RepoBasicInfoWithTagQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<RepoBasicInfoWithTagQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RepoBasicInfoWithTagQuery>(RepoBasicInfoWithTagDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RepoBasicInfoWithTag');
    }
  };
}
